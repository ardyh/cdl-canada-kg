...
col2range_n = {
    'agent_norm_clean': range_empty,  #range_n_clusters_short,
    'action_or_event_norm_clean': range_empty,  #range_n_clusters_long,
    'object_norm_clean': range_empty,  #range_n_clusters_med,
    'narrative_clean': range_empty,  #range_n_clusters_longest,
    'agent_or_object_norm_clean': range_n_clusters_long,
}
...
fname = './data/scoring/clustering_scores_agglomerative_agent_object_combined.xlsx'
